            ...
            <button
              ...
              className={`w-full flex items-center gap-3 p-3 text-left transition-colors relative ${
                selectedUser?._id === user._id
                  ...
                  ? "bg-gray-800 text-gray-100 ring-1 ring-green-500 hover:bg-gray-700" // Highlight for online users
                  : "bg-gray-900 text-gray-200 hover:bg-gray-700" // Default state
              }`}
            >
              {/* Avatar */}
              ...
              <div className="flex-1 min-w-0">
                ...
                {/* Status - Visible on larger screens */}
