...
const ProfilePage = () => {
  ...
  return (
    <div className="min-h-screen mt-2 bg-gradient-to-br from-gray-900 via-black to-gray-800 flex items-center justify-center p-6">
      <div className="w-full max-w-lg space-y-6">
        ...
        <div className="relative bg-gray-900/90 backdrop-blur-lg rounded-2xl shadow-2xl border border-gray-700/50 p-6 transition-all duration-300 hover:shadow-[0_0_20px_rgba(0,255,255,0.2)]">
          ...
          <div className="flex justify-center mb-6">
            <div className="relative">
              <img
                ...
                alt="Profile"
                className="w-28 h-28 rounded-full object-cover border-4 border-transparent bg-gradient-to-r from-cyan-500 to-blue-500 p-1 animate-[spin_4s_linear_infinite] hover:scale-105 transition-transform duration-300"
              />
              <div className="absolute inset-0 rounded-full border-2 border-cyan-400 opacity-50 animate-[pulse_2s_infinite]"></div>
            </div>
          </div>
          ...
          <div className="text-center text-gray-400 mb-6">
            <p className="text-sm">Update your avatar:</p>
            <input
              type="file"
              accept="image/*"
              onChange={handleFileChange}
              className="mt-2 text-sm text-gray-300 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-gradient-to-r file:from-cyan-500 file:to-blue-600 file:text-white hover:file:from-cyan-600 hover:file:to-blue-700 transition-all duration-300"
            />
          </div>
