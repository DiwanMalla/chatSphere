              ...
              <div className="flex justify-center mb-6">
                <div className="relative">
                  ...
                  <label
                    ...
                    className={`absolute bottom-0 right-0 bg-gray-800 p-2 rounded-full cursor-pointer transition-all duration-200 hover:bg-gray-700 ${
                      isUpdatingProfile
            ...
            <form onSubmit={handlePasswordSubmit} className="space-y-4">
              <div>
                ...
                <input
                  ...
                  className="w-full px-4 py-2 rounded-lg bg-gray-800/70 border border-gray-600/50 text-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-cyan-400 transition-all duration-300 hover:bg-gray-700/80"
              ...
              <button
                type="submit"
                disabled={isUpdatingProfile}
                className={`w-full py-2 bg-gradient-to-r from-cyan-500 to-blue-600 text-white font-semibold rounded-lg shadow-lg focus:outline-none transition-all duration-300 transform hover:scale-105 ${
                  isUpdatingProfile
                    ? "opacity-50 cursor-not-allowed"
                    : "hover:from-cyan-600 hover:to-blue-700"
                }`}
